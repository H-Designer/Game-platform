...
<body>
<h3 style="text-align: center;">本网站可交易的王者荣耀账号如下，可与喜欢的账号号主进行电话联系</h3>
<hr color="blue" />

		<table align="center" border="1">
				   <tr >
				   			<td colspan="4" align="center">系统信息数据</td>
				   </tr>
					<tr>
					...
					<%
							...
							List<information> informations=gamedao.selectgame("wangzhe");
							for(information infor:informations )
							{
					%>
					<tr>
							<td style="text-align: center; "><input type="text"   value="<%=infor.getId()%> " name="id"  disabled="disabled"> </td>
